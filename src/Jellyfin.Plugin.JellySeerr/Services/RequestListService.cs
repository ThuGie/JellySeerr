...
public class RequestListService
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            _logger.LogWarning(ex, "JS • failed to fetch Seerr requests");
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            _logger.LogDebug(ex, "JS • failed to proxy Seerr avatar");
            return (null, null);
        }
    }
    ...
    private Guid? ResolveLibraryItemId(User user, string? type, int tmdbId, Dictionary<string, Guid?> cache)
    {
        ...
        {
            _logger.LogDebug(ex, "JS • failed to resolve Jellyfin item for {Type}/{TmdbId}", type, tmdbId);
        }
